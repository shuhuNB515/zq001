...
import { ssrRenderComponent, ssrRenderSlot, ssrRenderVNode, ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate } from "vue/server-renderer";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60" }, _attrs, { "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "46", "data-source-line-end": "110" }))}><div class="container mx-auto flex h-20 items-center justify-between px-4" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="47" data-source-line-end="109"><a href="./homepage.html" class="flex items-center space-x-3 hover:opacity-80 transition-opacity" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="49" data-source-line-end="56"><div class="w-14 h-14 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-lg" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="50" data-source-line-end="52"><img src="/src/assets/png/智取未来.png" alt="智取未来" class="w-full h-full rounded-xl object-cover" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="51" data-source-line-end="51"></div><span class="text-3xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="53" data-source-line-end="55"> 智取未来 </span></a>`), $props.showNav && $props.variant === "default" ? (_push('<nav class="hidden md:flex items-center space-x-1" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="59" data-source-line-end="68"><!--[-->'), ssrRenderList($setup.navLinks, (link) => {
    _push(`<a${ssrRenderAttr("href", link.href)} class="px-4 py-2 text-sm font-medium text-foreground/80 hover:text-foreground hover:bg-accent/50 rounded-md transition-colors" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="60" data-source-line-end="67">${ssrInterpolate(link.name)}</a>`);
  }), _push("<!--]--></nav>")) : _push("<!---->"), _push('<div class="flex items-center space-x-2" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="71" data-source-line-end="108">'), $props.currentUser && $setup.isMounted ? (_push(`<div class="hidden md:flex items-center space-x-3" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="72" data-source-line-end="78"><span class="text-sm text-muted-foreground" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="73" data-source-line-end="73">${ssrInterpolate($props.currentUser)}</span>`), _push(ssrRenderComponent($setup.Button, { variant: "outline", size: "sm", onClick: $setup.handleLogout, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "74", "data-source-line-end": "77" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
    if (_push2) _push2(ssrRenderComponent($setup.SafeIcon, { name: "LogOut", size: 16, class: "mr-2", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "75", "data-source-line-end": "75" }, null, _parent2, _scopeId)), _push2(" 退出登录 ");
    else return [createVNode($setup.SafeIcon, { name: "LogOut", size: 16, class: "mr-2", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "75", "data-source-line-end": "75" }), createTextVNode(" 退出登录 ")];
  }), _: 1 }, _parent)), _push("</div>")) : _push("<!---->"), $props.showNav && $props.variant === "default" ? _push(ssrRenderComponent($setup.Sheet, { open: $setup.isMenuOpen, "onUpdate:open": ($event) => $setup.isMenuOpen = $event, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "81", "data-source-line-end": "107" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
    if (_push2) _push2(ssrRenderComponent($setup.SheetTrigger, { "as-child": "", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "82", "data-source-line-end": "86" }, { default: withCtx((_2, _push3, _parent3, _scopeId2) => {
      if (_push3) _push3(ssrRenderComponent($setup.Button, { variant: "ghost", size: "icon", class: "md:hidden", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "83", "data-source-line-end": "85" }, { default: withCtx((_3, _push4, _parent4, _scopeId3) => {
        if (_push4) _push4(ssrRenderComponent($setup.SafeIcon, { name: "Menu", size: 24, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "84", "data-source-line-end": "84" }, null, _parent4, _scopeId3));
        else return [createVNode($setup.SafeIcon, { name: "Menu", size: 24, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "84", "data-source-line-end": "84" })];
      }), _: 1 }, _parent3, _scopeId2));
      else return [createVNode($setup.Button, { variant: "ghost", size: "icon", class: "md:hidden", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "83", "data-source-line-end": "85" }, { default: withCtx(() => [createVNode($setup.SafeIcon, { name: "Menu", size: 24, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "84", "data-source-line-end": "84" })]), _: 1 })];
    }), _: 1 }, _parent2, _scopeId)), _push2(ssrRenderComponent($setup.SheetContent, { side: "right", class: "w-64", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "87", "data-source-line-end": "106" }, { default: withCtx((_2, _push3, _parent3, _scopeId2) => {
      if (_push3) _push3(`<nav class="flex flex-col space-y-4 mt-8" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="88" data-source-line-end="105"${_scopeId2}><!--[-->`), ssrRenderList($setup.navLinks, (link) => {
        _push3(`<a${ssrRenderAttr("href", link.href)} class="px-4 py-3 text-sm font-medium text-foreground hover:bg-accent rounded-md transition-colors" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="89" data-source-line-end="97"${_scopeId2}>${ssrInterpolate(link.name)}</a>`);
      }), _push3("<!--]-->"), $props.currentUser && $setup.isMounted ? (_push3(`<div class="pt-4 border-t" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="98" data-source-line-end="104"${_scopeId2}><p class="px-4 py-2 text-sm text-muted-foreground" data-source-file="src/components/common/CommonHeader.vue" data-source-line-start="99" data-source-line-end="99"${_scopeId2}>${ssrInterpolate($props.currentUser)}</p>`), _push3(ssrRenderComponent($setup.Button, { variant: "outline", size: "sm", class: "w-full", onClick: $setup.handleLogout, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "100", "data-source-line-end": "103" }, { default: withCtx((_3, _push4, _parent4, _scopeId3) => {
        if (_push4) _push4(ssrRenderComponent($setup.SafeIcon, { name: "LogOut", size: 16, class: "mr-2", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "101", "data-source-line-end": "101" }, null, _parent4, _scopeId3)), _push4(" 退出登录 ");
        else return [createVNode($setup.SafeIcon, { name: "LogOut", size: 16, class: "mr-2", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "101", "data-source-line-end": "101" }), createTextVNode(" 退出登录 ")];
      }), _: 1 }, _parent3, _scopeId2)), _push3("</div>")) : _push3("<!---->"), _push3("</nav>");
      else return [createVNode("nav", { class: "flex flex-col space-y-4 mt-8", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "88", "data-source-line-end": "105" }, [(openBlock(), createBlock(Fragment, null, renderList($setup.navLinks, (link) => createVNode("a", { key: link.name, href: link.href, class: "px-4 py-3 text-sm font-medium text-foreground hover:bg-accent rounded-md transition-colors", onClick: ($event) => $setup.isMenuOpen = false, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "89", "data-source-line-end": "97" }, toDisplayString(link.name), 9, ["href", "onClick"])), 64)), $props.currentUser && $setup.isMounted ? (openBlock(), createBlock("div", { key: 0, class: "pt-4 border-t", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "98", "data-source-line-end": "104" }, [createVNode("p", { class: "px-4 py-2 text-sm text-muted-foreground", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "99", "data-source-line-end": "99" }, toDisplayString($props.currentUser), 1), createVNode($setup.Button, { variant: "outline", size: "sm", class: "w-full", onClick: $setup.handleLogout, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "100", "data-source-line-end": "103" }, { default: withCtx(() => [createVNode($setup.SafeIcon, { name: "LogOut", size: 16, class: "mr-2", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "101", "data-source-line-end": "101" }), createTextVNode(" 退出登录 ")]), _: 1 })])) : createCommentVNode("", true)])];
    }), _: 1 }, _parent2, _scopeId));
    else return [createVNode($setup.SheetTrigger, { "as-child": "", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "82", "data-source-line-end": "86" }, { default: withCtx(() => [createVNode($setup.Button, { variant: "ghost", size: "icon", class: "md:hidden", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "83", "data-source-line-end": "85" }, { default: withCtx(() => [createVNode($setup.SafeIcon, { name: "Menu", size: 24, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "84", "data-source-line-end": "84" })]), _: 1 })]), _: 1 }), createVNode($setup.SheetContent, { side: "right", class: "w-64", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "87", "data-source-line-end": "106" }, { default: withCtx(() => [createVNode("nav", { class: "flex flex-col space-y-4 mt-8", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "88", "data-source-line-end": "105" }, [(openBlock(), createBlock(Fragment, null, renderList($setup.navLinks, (link) => createVNode("a", { key: link.name, href: link.href, class: "px-4 py-3 text-sm font-medium text-foreground hover:bg-accent rounded-md transition-colors", onClick: ($event) => $setup.isMenuOpen = false, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "89", "data-source-line-end": "97" }, toDisplayString(link.name), 9, ["href", "onClick"])), 64)), $props.currentUser && $setup.isMounted ? (openBlock(), createBlock("div", { key: 0, class: "pt-4 border-t", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "98", "data-source-line-end": "104" }, [createVNode("p", { class: "px-4 py-2 text-sm text-muted-foreground", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "99", "data-source-line-end": "99" }, toDisplayString($props.currentUser), 1), createVNode($setup.Button, { variant: "outline", size: "sm", class: "w-full", onClick: $setup.handleLogout, "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "100", "data-source-line-end": "103" }, { default: withCtx(() => [createVNode($setup.SafeIcon, { name: "LogOut", size: 16, class: "mr-2", "data-source-file": "src/components/common/CommonHeader.vue", "data-source-line-start": "101", "data-source-line-end": "101" }), createTextVNode(" 退出登录 ")]), _: 1 })])) : createCommentVNode("", true)])]), _: 1 })];
