...
export const ADMIN_USER_AVATAR_IMAGE = {
  url: "https://spark-builder.s3.cn-north-1.amazonaws.com.cn/image/2025/11/26/3f743603-52d5-4c0c-9075-d7a0ca453c1b.png",
};
...
export type VerificationRecordModel = {
  recordId: string;
  userId: string;
  userName: string;
...
export const MOCK_VERIFICATION_RECORDS: VerificationRecordModel[] = [
  {
    recordId: "VR001",
    userId: "U001",
    userName: "张三",
...
export type PricingConfigModel = {
    serviceType: string;
    weightRange: string;
    initialPrice: number;
...
export const MOCK_PRICING_CONFIG: PricingConfigModel[] = [
    {
        serviceType: "标准快递",
        weightRange: "0-1 kg",
        initialPrice: 12.00,
...
// --- Storage Duration Config ---

export type StorageDurationRuleModel = {
    ruleId: number;
    description: string;
    freeDays: number;
    penaltyRate: number;
    validityStatus: "Active" | "Pending";
};

export const MOCK_STORAGE_DURATION_RULES: StorageDurationRuleModel[] = [
    {
        ruleId: 1,
        description: "标准快件免费存储规则",
        freeDays: 7,
        penaltyRate: 1.00, // 1.00元/天
...
// --- Device Monitoring Images (re-listed for clarity) ---
